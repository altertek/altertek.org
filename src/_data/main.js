module.exports = {
  ...
  en: {
    ...
    showcase: {
      ...
      subtitle: "Altertek is a non-profit organisation whose aim is to promote alternatives in terms of the use and design of Information and Communication Technologies to preserve the environment and our resources.",
      columns: [
        {
          icon: "book",
